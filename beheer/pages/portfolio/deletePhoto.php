...
$query = "SELECT *, ph.id as photo_portfolio_album FROM photo ph JOIN portfolio pr ON ph.pportfolio_album = pr.portfolio_album WHERE ph.portfolio_album = '".urlSegment(3)."' LIMIT 1";
